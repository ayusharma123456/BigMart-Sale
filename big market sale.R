...
set.seed(1237) 
my_control = trainControl(method = "cv",number= 5)#cross valadition 
Grid=expand.grid(alpha=seq(0,1,length=10),lambda= seq(0.001, 0.1, by = 0.0002))
...
#ridge   0.5595   1132.5
#lasso   0.5635   1127.3
#elastic 0.5595  1132.5

#in this comparing we have lasso with 56% and less RMSE 1127
...
#mtryno. of predicator variables randomly sampled at each split
#min.node.size min size of terminal node reduce overfitting
